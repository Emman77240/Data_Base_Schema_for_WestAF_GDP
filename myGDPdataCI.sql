...
--
-- Host: localhost    Database: myGDPdata
-- ------------------------------------------------------
...
CREATE TABLE `country_info` (
  ...
  `SizeSQKM` int(11) DEFAULT NULL,
  `DollarGDP` int(11) DEFAULT NULL,
...
INSERT INTO `country_info` VALUES (1,'Benin',114763,9274000),(2,'Ghana',238535,47330000),(3,'Nigeria',923768,375771000);
...
-- Dump completed on 2018-10-05 16:19:32
